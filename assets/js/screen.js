(function () {
    ...
    e.fn.fancySelect = function (t) {
        ...
        return this.each(function () {
            var t, i, s, o, u, a, f;
            o = e(this);
            if (o.hasClass("fancified") || o[0].tagName !== "SELECT") {
                return
            }
            ...
            o.wrap('<div class="fancy-select">');
            f = o.parent();
            if (o.data("class")) {
                f.addClass(o.data("class"))
            }
            f.append('<div class="trigger">');
            if (!(n && !r.forceiOS)) {
                f.append('<ul class="options">')
            }
            u = f.find(".trigger");
            s = f.find(".options");
            i = o.prop("disabled");
            ...
            a = function () {
                var e;
                e = r.triggerTemplate(o.find(":selected"));
                return u.html(e)
            };
            o.on("blur.fs", function () {
                if (u.hasClass("open")) {
                    return setTimeout(function () {
                        return u.trigger("close.fs")
                    }, 120)
                }
            });
            u.on("close.fs", function () {
                u.removeClass("open");
                return s.removeClass("open")
            });
            u.on("click.fs", function () {
                var t, a;
                if (!i) {
                    u.toggleClass("open");
                    if (n && !r.forceiOS) {
                        ...
                        if (u.hasClass("open")) {
                            a = u.parent();
                            t = a.offsetParent();
                            if (a.offset().top + a.outerHeight() + s.outerHeight() + 20 > e(window).height() + e(window).scrollTop()) {
                                s.addClass("overflowing")
                            }
                            else {
                                s.removeClass("overflowing")
                            }
                        }
                        s.toggleClass("open");
                        if (!n) {
            ...
            o.on("keydown", function (e) {
                ...
                t.removeClass("hover");
                if (!s.hasClass("open")) {
                    if (r === 13 || r === 32 || r === 38 || r === 40) {
                        e.preventDefault();
                        return u.trigger("click.fs")
                    }
                }
                else {
                    if (r === 38) {
                        e.preventDefault();
                        if (t.length && t.index() > 0) {
                            t.prev().addClass("hover")
                        }
                        else {
                            s.find("li:last-child").addClass("hover")
                        }
                    }
                    else if (r === 40) {
                        e.preventDefault();
                        if (t.length && t.index() < s.find("li").length - 1) {
                            t.next().addClass("hover")
                        }
                        else {
                            s.find("li:first-child").addClass("hover")
                        }
                    }
                    else if (r === 27) {
                        e.preventDefault();
            ...
            s.on("click.fs", "li", function (t) {
                var r;
                r = e(this);
                o.val(r.data("raw-value"));
                if (!n) {
                    o.trigger("blur.fs").trigger("focus.fs")
                }
                s.find(".selected").removeClass("selected");
                r.addClass("selected");
                return o.val(r.data("raw-value")).trigger("change.fs").trigger("blur.fs").trigger("focus.fs")
            });
            ...
            t = function () {
                ...
                t = o.find("option");
                return o.find("option").each(function (t, n) {
                    var i;
                    n = e(n);
                    if (!n.prop("disabled") && (n.val() || r.includeBlank)) {
                        i = r.optionTemplate(n);
                        if (n.prop("selected")) {
                            return s.append('<li data-raw-value="' + n.val() + '" class="selected">' + i + "</li>")
                        }
                        else {
                            return s.append('<li data-raw-value="' + n.val() + '">' + i + "</li>")
                        }
                    }
                })
            };
            o.on("update.fs", function () {
                f.find(".options").empty();
                return t()
            });
            return t()
        })
...
(function () {
    ...
    (function (t, e) {
        if (typeof define === "function" && define.amd) {
            return define("tppoints", ["jquery"], function (n) {
                return e(n, t)
            })
        }
        else {
        ...
        f = 1;
        c = {};
        u = "tppoints-context-id";
        p = "resize.tppoints";
        y = "scroll.tppoints";
        v = 1;
        w = "tppoints-tppoint-ids";
        g = "tppoint";
        m = "tppoints";
        o = function () {
            function t(t) {
            ...
            t.prototype.doScroll = function () {
                ...
                n.each(t, function (t, r) {
                    ...
                    n.each(e.tppoints[t], function (t, e) {
                        var n, i;
            ...
            t.prototype.refresh = function () {
                ...
                return n.each(t, function (t, e) {
                    return n.each(i.tppoints[t], function (t, r) {
                        var i, o, l, s, f;
                        i = r.options.offset;
                        l = r.offset;
            ...
            t.prototype.checkEmpty = function () {
                if (n.isEmptyObject(this.tppoints.horizontal) && n.isEmptyObject(this.tppoints.vertical)) {
        ...
        l = function () {
            function t(t, e, r) {
                ...
                this.offset = null;
                this.options = r;
                e.tppoints[this.axis][this.id] = this;
            ...
            t.prototype.destroy = function () {
                ...
                delete this.context.tppoints[this.axis][this.id];
                return this.context.checkEmpty()
            };
            t.gettppointsByElement = function (t) {
                var e, r;
                r = t[w];
                if (!r) {
                    return []
        ...
        n.fn[g] = function () {
            ...
            if (d[r]) {
                ...
                return n.error("jQuery tppoints needs a callback function or handler option.")
            }
            else {
                return n.error("The " + r + " method does not exist in jQuery tppoints.")
            }
        };
        n.fn[g].defaults = {
            context: r
        ...
        h = {
            ...
            , aggregate: function (t) {
                ...
                e = s;
                if (t) {
                    e = (i = c[n(t)[0][u]]) != null ? i.tppoints : void 0
                }
                if (!e) {
                    return []
                }
            ...
            , _filter: function (t, e, r) {
                ...
                o = [];
                n.each(i.tppoints[e], function (t, e) {
                    if (r(i, e)) {
                        return o.push(e)
                    }
                });
...
(function () {
    (function (t, n) {
        if (typeof define === "function" && define.amd) {
            return define(["jquery", "tppoints"], n)
        }
        else {
            return n(t.jQuery)
        }
        ...
        t.tppoints("extendFn", "sticky", function (e) {
            var i, r, a;
            r = t.extend({}, t.fn.tppoint.defaults, n, e);
            i = s(this, r);
            a = r.handler;
        ...
        return t.tppoints("extendFn", "unsticky", function () {
            this.parent().tppoint("destroy");
            this.unwrap();
    ...
    return c.prototype = {
        ...
        , avg: function (b) {
            ...
            if (!c._avg || b) {
                ...
                c._avg = k ? [~~(m / k), ~~(n / k), ~~(o / k)] : [~~(l * (c.r1 + c.r2 + 1) / 2), ~~(l * (c.g1 + c.g2 + 1) / 2), ~~(l * (c.b1 + c.b2 + 1) / 2)]
            }
            return c._avg
        }
        , contains: function (a) {
...
var miamiticker = false
    , miamilastscrolltop, miamianimframeid, mainwin = jQuery(window)
    , mainwinh = 0
...
jQuery(document).ready(function () {
    ...
    if (jQuery('#header').hasClass("makeitsticky")) initStickyMenu();
    initStickyMainImage();
    initMegaMenu();
    initSearch();
    ...
    punchgs.TweenLite.set(jQuery('.ess_img_preview img'), {
        maxHeight: "0%"
        , autoAlpha: 0
    });
    initAnchors();
    ...
    if (window.location.pathname == "/kriki-page-load-private" || window.location.pathname == "/kriki" || window.location.pathname == "/kriki-page-load-private/" || window.location.pathname == "/kriki/") {
        ...
        var lbox = prew.find('.preloader-leftbox')
            ...
            , src = "http://www.themepunch.com/wp-content/uploads/2014/11/tplogo_grey.png"
            , srcloaded = "http://www.themepunch.com/wp-content/uploads/2014/11/tplogo_red.png";
        plogo.css({
            width: "163px"
            , height: "50px"
        });
        ...
        punchgs.TweenLite.set('.pre-smart-text', {
            marginTop: "60px"
        });
        punchgs.TweenLite.fromTo('.pre-logo-wrapper', 1, {
            force3D: "true"
            , scale: 0.2
            , autoAlpha: 0
            , top: "100%"
        ...
        punchgs.TweenLite.fromTo('.pre-smart-text', 1, {
            force3D: "true"
            , scale: 0.2
            , autoAlpha: 0
            , top: "120%"
        ...
        punchgs.TweenLite.to('.pre-logo-wrapper', 10, {
            force3D: "true"
            , top: "45%"
            , z: 0.01
        ...
        punchgs.TweenLite.to('.pre-smart-text', 9, {
            force3D: "true"
            , top: "45%"
            , z: 0.01
            , ease: punchgs.Power4.easeOut
        ...
        punchgs.TweenLite.to('.pre-logo-loaded', 0.5, {
            width: "100%"
        ...
        setTimeout(function () {
            ...
            case "curtain-down":
                punchgs.TweenLite.to('.preloader-leftbox', 0.8, {
                    transformOrigin: "100% 100%"
                    , rotation: -110
                });
                punchgs.TweenLite.to('.preloader-rightbox', 0.75, {
                ...
                break;
            case "slideright":
                punchgs.TweenLite.to('.preloader-leftbox', 0.6, {
                    transformOrigin: "100% 100%"
                    , x: "+200%"
                    , ease: punchgs.Power3.easeInOut
                });
                punchgs.TweenLite.to('.preloader-rightbox', 0.6, {
                    transformOrigin: "0% 100%"
                    , x: "+100%"
                    , ease: punchgs.Power3.easeInOut
                    , onComplete: function () {
            ...
            case "slidedown":
                ...
                break;
            case "foldleft":
                punchgs.TweenLite.to('.preloader-rightbox', 0.8, {
                ...
                punchgs.TweenLite.to('.preloader-wrapper', 0.8, {
                    transformPerspective: 600
                    , transformOrigin: "0% 50%"
                    , transformStyle: "flat"
                    , rotationY: 90
            ...
            case "pressright":
                ...
                punchgs.TweenLite.to('.preloader-leftbox', 1.2, {
                    x: "+200%"
                    , ease: punchgs.Power3.easeInOut
                    , delay: 0.6
                });
                ...
                break;
            case "pressleft":
                punchgs.TweenLite.set('.preloader-rightbox', {
                    zIndex: 1
                });
                punchgs.TweenLite.set('.preloader-leftbox', {
                    zIndex: 5
                });
                punchgs.TweenLite.to('.preloader-rightbox', 0.6, {
                    transformOrigin: "100% 100%"
                ...
                punchgs.TweenLite.to('.preloader-rightbox', 1.2, {
                    x: "-200%"
                    , ease: punchgs.Power3.easeInOut
                    , delay: 0.6
                });
                ...
                break;
            case "tp-effect":
                punchgs.TweenLite.to('.preloader-rightbox', 1, {
                    y: "-100%"
                    , ease: punchgs.Power3.easeInOut
                    , overwrite: "all"
                });
                punchgs.TweenLite.to('.preloader-leftbox', 1, {
                    y: "-100%"
                    , ease: punchgs.Power3.easeInOut
                    , overwrite: "all"
                });
                punchgs.TweenLite.to('.pre-logo-wrapper', 1, {
                    ease: punchgs.Power3.easeOut
                    , autoAlpha: 0
                    , delay: 0.1
                    , overwrite: "all"
                ...
                punchgs.TweenLite.to('.pre-smart-text', 1, {
                    top: "-20%"
                    , marginTop: 0
                    , ease: punchgs.Power2.easeInOut
                    , scale: 1
    ...
    var scevent, lastdoctop = doc.scrollTop()
        , polytimer;
    jQuery(window).on("scroll.basics", function () {
        docheight = doc.height();
        doctop = doc.scrollTop();
...
function initFAQSearch() {
    ...
    ip.val("");
    wr.find('.eg-search-clean').css({
        zIndex: 200
    });
    wr.find('.eg-search-submit').css({
        zIndex: 200
    });
    ...
    tl.pause();
    punchgs.TweenLite.set(wr, {
        autoAlpha: 1
        , zIndex: 100
        , position: "relative"
        , transformOrigin: "50% 50% -47px"
        , rotationX: 0
        , perspective: 1200
    });
    punchgs.TweenLite.set(sfa, {
        autoAlpha: 0
        , zIndex: 10
        , rotationX: 90
        , transformOrigin: "50% 50% -47px"
    ...
    ip.on("searchstarting", function () {
        ...
        punchgs.TweenLite.to(wr, 0.75, {
            autoAlpha: 0
            , rotationX: -90
            , ease: punchgs.Power3.easeInOut
        });
        punchgs.TweenLite.to(sfa, 0.75, {
            autoAlpha: 1
        ...
        var str = ip.val();
        sfa.html(str);
        var splitoriginal = new punchgs.SplitText(sfa, {
            type: "chars"
        });
        punchgs.TweenLite.set(splitoriginal.chars, {
            autoAlpha: 0
        });
        jQuery.each(splitoriginal.chars, function (index, ch) {
            var och = jQuery(ch).text();
            tls.add(punchgs.TweenLite.to(ch, 0.3, {
                autoAlpha: 1
                , ease: punchgs.Power3.easeInOut
                , onUpdate: function () {
                    jQuery(ch).html(randomString(1));
                }
                , onComplete: function () {
                    jQuery(ch).html(och);
                }
        ...
        if ((screenpos > -50 && screenpos < mainwinh + 150) || colorit) {
            if (pn.hasClass("poly-negative")) {
                if (pn.hasClass("poly-bottom")) {
                    if (animdir == "invers") ch = ch - (ch * (((mainwinh - screenpos) / mainwinh)));
                    else ch = Math.round(ch * ((mainwinh - screenpos) / mainwinh));
                    if (ch < 0) ch = 0;
                    if (ch > sh) ch = sh;
                    if (is_mobile()) ch = sh;
                    pn.find('.left-poly-side').each(function () {
                        var ps = jQuery(this);
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: ch + "px 0px 0px " + ((mainwinw * lw) + 1) + "px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent transparent transparent " + bgcol
                        });
                    });
                    pn.find('.right-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: "0px 0px " + ch + "px " + (mainwinw * rw) + "px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent transparent " + bgcol + " transparent"
                        });
                    });
                }
                else {
                    if (animdir == "invers") ch = ch - (ch * ((screenpos / mainwinh)));
                    else ch = Math.round(ch * (screenpos / mainwinh));
                    if (ch < 0) ch = 0;
                    if (ch > sh) ch = sh;
                    if (is_mobile()) ch = sh;
                    pn.find('.left-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: ch + "px " + ((mainwinw * lw) + 1) + "px 0px 0px"
                        });
                        if (colorit) ps.css({
                            borderColor: bgcol + " transparent transparent transparent"
                        });
                    });
                    pn.find('.right-poly-side').each(function () {
                        var ps = jQuery(this);
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: "0px " + (mainwinw * rw) + "px " + ch + "px 0px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent " + bgcol + " transparent transparent"
                        });
                    });
                }
            }
                ...
                if (pn.hasClass("poly-bottom")) {
                    ...
                    pn.find('.left-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: "0px 0px " + ch + "px " + ((mainwinw * lw) + 1) + "px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent transparent " + bgcol + " transparent"
                        });
                    ...
                    pn.find('.right-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: ch + "px 0px 0px " + (mainwinw * rw) + "px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent transparent transparent " + bgcol
                        });
                    ...
                    pn.find('.left-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: "0px " + ((mainwinw * lw) + 1) + "px " + ch + "px 0px"
                        });
                        if (colorit) ps.css({
                            borderColor: "transparent " + bgcol + " transparent transparent"
                        });
                    ...
                    pn.find('.right-poly-side').each(function () {
                        ...
                        punchgs.TweenLite.to(ps, 0.6, {
                            overwrite: "all"
                            , ease: punchgs.Power3.easeOut
                            , borderWidth: ch + "px " + (mainwinw * rw) + "px 0px 0px"
                        });
                        if (colorit) ps.css({
                            borderColor: bgcol + " transparent transparent transparent"
                        });
    ...
    jQuery('.onepagermenu #navigation .menu-link, .docu-link').each(function (i) {
        ...
        if (!a.parent().hasClass("docuwithsubmenu")) {
            ...
            if (obj.href != undefined) {
                ...
                if (obj.target != undefined && obj.target.length > 0) anchorarray.push(obj);
            }
        }
    });
        ...
        a.click(function () {
            ...
            if (a.attr('href') != undefined) {
                ...
                if (obj.href != undefined && obj.target != undefined && jQuery(obj.target).length > 0) {
                    ...
                    if (jQuery('body').data('currenscrollanim') != undefined) jQuery('body').data('currenscrollanim').pause();
...
function checkAnchors(aa) {
    jQuery.each(aa, function (index, obj) {
        if (obj && obj != undefined && obj.target != undefined && jQuery(obj.target).length > 0) obj.top = jQuery(obj.target).offset().top;
    });
}
var showItemInBig = function (obj) {
    ...
    img.onload = function () {
        if (cv == 0) {
            imga.attr('src', src);
            punchgs.TweenLite.to(imga, 0.5, {
                position: "relative"
                , maxHeight: "100%"
                , autoAlpha: 1
            });
            punchgs.TweenLite.to(imgb, 0.5, {
                position: "absolute"
                , maxHeight: "100%"
                , autoAlpha: 0
            });
        ...
        punchgs.TweenLite.to(jQuery('body, html'), 2, {
...
function imageHovers() {
    ...
    jQuery('.tp-imghover-wrapper').each(function () {
        ...
        imgl.onload = function () {
            ...
            if (isCanvasSupported) {
                try {
                    ...
                    hov.css({
                        background: 'rgba(' + imgcolor[0] + ',' + imgcolor[1] + ',' + imgcolor[2] + ',1)'
                    });
        ...
        punchgs.TweenLite.set(imgp, {
            perspective: 600
            , force3D: "true"
            , transformStyle: "flat"
        });
        var animlib = [["charlie", ['img', 0.3, {
                scale: 1.1
                , xPercent: -5
                , x: 0
                , transformOrigin: "50% 50%"
                ...
                xPercent: 0
                , scale: 1.1
            }, 0], ['.tp-imghover-hover', 0.3, {
                autoAlpha: 0.3
            }, {
                autoAlpha: 0
            }, 0], ['.tp-imghover-title', 0.3, {
                autoAlpha: 1
                , x: 0
                , y: 10
            }, {
                ...
                , x: 0
                , y: 0
            }, 0.1]], ["rocky", ['.tp-imghover-hover', 0.2, {
                autoAlpha: 0
            }, {
                autoAlpha: 0.3
            }, 0], ['.tp-imghover-title', 0.3, {
                ...
                , y: 0
                , rotationX: 0
            }, 0, true, "words", 0.12], ['.tp-imghover-subtitle', 0.3, {
                autoAlpha: 1
                , x: 0
                , y: 0
            }, {
                ...
                , y: 0
                , rotationX: 0
            }, 0, true, "words", 0.01], ['.tp-imghover-bottomline', 0.3, {
                autoAlpha: 1
                , height: 0
            }, {
                autoAlpha: 1
                ...
                , x: 0
                , y: 0
            }, 0.1], ['.tp-imghover-topline', 0.3, {
                autoAlpha: 0
                , scaleX: 0
            }, {
                autoAlpha: 1
                , scaleX: 1
            }, 0.2], ['.tp-imghover-bottomline', 0.4, {
                autoAlpha: 0
                , scaleX: 0
            }, {
                autoAlpha: 1
                , scaleX: 1
            }, 0.1], ['.tp-imghover-leftline', 0.2, {
                autoAlpha: 0
                , scaleY: 0
            }, {
                autoAlpha: 1
                , scaleY: 1
            }, 0.3], ['.tp-imghover-rightline', 0.35, {
                autoAlpha: 0
                , scaleY: 0
            }, {
                autoAlpha: 1
                , scaleY: 1
            }, 0.15]], ["buster", ['.tp-imghover-hover', 0.2, {
                autoAlpha: 0
            }, {
                autoAlpha: 0.6
            }, 0], ['.tp-imghover-title', 0.3, {
                ...
                , x: 0
                , y: 0
            }, 0, true, "words", 0.005]], ["murphy", ['.tp-imghover-hover', 0.2, {
                autoAlpha: 0
            }, {
                autoAlpha: 0.7
            }, 0], ['.tp-imghover-title', 0.2, {
                autoAlpha: 1
                , x: 0
                , y: 0
            }, {
            ...
            if (imgp.hasClass(anim[0])) {
                jQuery.each(anim, function (index, obj) {
                    if (index > 0) {
                        ...
                        if (obj[5]) {
                            var splitt = new punchgs.SplitText(elem, {
                                type: obj[6]
                            });
                        ...
                        else timeline.add(punchgs.TweenLite.fromTo(elem, obj[1], obj[2], obj[3]), obj[4]);
                    }
                });
            }
        });
...
function imgClasser(imgp) {
    var img = jQuery(this).find('img')
        , ww = imgp.width()
        , hh = imgp.height();
    if (ww > 390) imgp.removeClass("mediumimage").removeClass("smallimage");
    else
    if (ww > 270) imgp.addClass("mediumimage").removeClass("smallimage");
    else imgp.removeClass("mediumimage").addClass("smallimage");
}
...
function stickyFooter() {
    ...
    function stickyFooterDraw() {
        ...
        punchgs.TweenLite.set(jQuery('#footer .footer-inner .widgetslot .footer_widget, #footer .footer-inner .widgetslot .sidebar_widget'), {
            opacity: opa
        });
    }
}
...
function setMBBottom() {
    ...
    if (enabled) jQuery('#bodywrapper').css({
        marginBottom: (Math.round(jQuery('#footer').height()) - 1) + "px"
    });
    else jQuery('#bodywrapper').css({
        marginBottom: "0px"
    });
}
...
function initSlideInBar() {
    ...
    punchgs.TweenLite.set(jQuery('#sidewidgetpanel .footer_widget, #sidewidgetpanel .sidebar_widget'), {
        transformOrigin: "50% 50%"
        , force3D: "auto"
        , scaleX: 0
        , autoAlpha: 0
    ...
    jQuery('.theplusbutton').click(function () {
        ...
        if (swp.hasClass("opened")) {
            ...
            punchgs.TweenLite.to(tpb, 0.5, {
                rotationZ: 0
                , ease: punchgs.Power2.easeOut
            });
            punchgs.TweenLite.to(jQuery('#sidewidgetpanel .footer_widget, #sidewidgetpanel .sidebar_widget'), 0.3, {
                autoAlpha: 0
                , onComplete: function () {
                    punchgs.TweenLite.set(jQuery('#sidewidgetpanel .footer_widget, #sidewidgetpanel .sidebar_widget'), {
                        scaleX: 0
            ...
            punchgs.TweenLite.fromTo(swp, 0.5, {
                autoAlpha: 1
                , x: 0
            }, {
                autoAlpha: 0
...
function setShareMeHovers(smc, sh) {
    var tween = new punchgs.TimelineLite()
        ...
        , ar = new Array();
    maxh = 0, count = 0, tr = {}, sh.find('.shareme').each(function () {
        count++;
        maxh += jQuery(this).outerHeight();
        ar.unshift(jQuery(this));
    });
    sh.find('.sharemask').height(maxh + 5);
    tween.fromTo(sh, (count * 0.2), {
        height: 0
    }, {
        height: maxh + 10
        , ease: punchgs.Power3.easeInOut
    });
    tweensm.staggerFromTo(ar, 0.5, {
        autoAlpha: 0
    }, {
        autoAlpha: 1
        , ease: punchgs.Power2.easeInOut
...
function drawParallaxImages(force) {
    if (doctop != lastknowndoctop || force) {
        ...
        jQuery.each(parallaxobjects, function (index, pobj) {
            punchgs.TweenLite.set(pobj.bgparoff, {
                force3D: "auto"
                , y: pobj.offs
            });
        });
...
function parallaxBGPosition() {
    ...
    jQuery.each(parallaxobjects, function (index, pobj) {
        ...
        pobj.oftop = pobj.bgpar.offset().top, pobj.reltop = mainwinh - (pobj.oftop - doctop), pobj.hdif = (pobj.bgimg.height() - pobj.bgh) / 2, pobj.stage = mainwinh + pobj.bgh;
...
function parallaxSizeCalculation() {
    jQuery.each(parallaxobjects, function (index, pobj) {
        ...
        hr = hr * factor;
        vr = vr * factor;
        punchgs.TweenLite.to(pobj.bgimg, 1, {
            maxWidth: hr + "%"
            , maxHeight: vr + "%"
            , overwrite: "all"
        });
...
function parallaxResizing() {
    jQuery.each(parallaxobjects, function (index, pobj) {
        if (pobj.isvideo) {
            if (pobj.bgimg.hasClass("videovisible")) try {
...
function initSpaceHoverFun() {
    jQuery('.space_hoover').each(function () {
        var sh = jQuery(this);
        punchgs.TweenLite.set(sh.parent(), {
        ...
        punchgs.TweenLite.set(sh.find("img"), {
            scale: 0.98
            , rotationX: 0
            , rotationY: 0
            , x: 0
    ...
    jQuery('.testimonial_slider').each(function () {
        ...
        ts.find('.bullet').each(function () {
            ...
            b.click(function () {
                ...
                b.addClass("selected");
                punchgs.TweenLite.to(old_slide, 0.5, {
                    autoAlpha: 0
                    , rotationY: ryt
                    , x: xt
                    , y: yt
                ...
                punchgs.TweenLite.fromTo(new_slide, 0.5, {
                    autoAlpha: 0
                    , rotationY: ryf
                    , x: xf
                    , y: yf
                ...
                punchgs.TweenLite.to(ts.find('ul'), 0.5, {
                    height: new_slide.height()
                });
            })
        });
    });
    jQuery(window).resize(function () {
        jQuery('.testimonial_slider').each(function () {
            var ts = jQuery(this)
                ...
                , new_slide = b.data('li');
            if (ts.find('ul').length > 0 && new_slide != undefined) punchgs.TweenLite.to(ts.find('ul'), 0.5, {
                height: new_slide.height()
            });
        });
    });
...
function menuLayoutManager() {
    var hiw = jQuery('#header_inner_wrapper')
        , head = jQuery('#header');
    bod = jQuery('body');
    if (doctop > 5) bod.addClass("pagescrolled")
    else bod.removeClass("pagescrolled")
...
function initPageTitleParallax(divider) {
    jQuery(window).on("scroll.pagetitleparallax", function () {
        if (mainwinw > 767) punchgs.TweenLite.to(jQuery('#pagetitle'), 0.01, {
            bottom: (0 + (doctop / divider))
        });
        else punchgs.TweenLite.to(jQuery('#pagetitle'), 0.01, {
            bottom: 0
        });
    });
}
...
function initMenuBackgroundColors() {
    jQuery('#navigation li').each(function () {
        var li = jQuery(this);
        if (li.hasClass("megamenu")) li.find('ul').first().css({
            backgroundColor: li.data('backgroundcolor')
        });
        else li.find('ul').css({
            backgroundColor: li.data('backgroundcolor')
        });
...
function shortHandleMegamenuUl(li, handler) {
    ...
    ul.find('>li').each(function () {
        ...
        if (li.position().left < lastlipos) {
            minheightIndex++;
            if (lastli != undefined && lastli.length > 0) lastli.addClass("norightborder");
        }
        if (li.height() > minheight[minheightIndex]) minheight[minheightIndex] = li.height();
    ...
    setTimeout(function () {
        ul.find('>li').each(function () {
            var li = jQuery(this);
            if (li.position().left < lastlipos) minheightIndex++;
            li.css({
                minHeight: minheight[minheightIndex]
            });
            lastlipos = li.position().left;
        })
        if (minheightIndex > 1) li.addClass("leftoriented");
        else li.removeClass("leftoriented");
        switch (handler) {
        case "set":
            punchgs.TweenLite.set(inside, {
                autoAlpha: 0
            });
            ul.css({
                width: hiw_w + "px"
                , left: ((0 - li.offset().left) + hiw_l) + "px"
            });
            punchgs.TweenLite.set(ul, {
                autoAlpha: 0
                , transformOrigin: "50% 0%"
            });
            punchgs.TweenLite.set(ul.find('.footer_widget, .sidebar_widget'), {
                scaleY: 0
            });
            break;
        case "show":
            ...
            punchgs.TweenLite.to(inside, 0.01, {
                autoAlpha: 1
                , ease: punchgs.Power2.easeOut
                , clearProps: "transform"
            });
            punchgs.TweenLite.to(ul, 0.01, {
                autoAlpha: 1
                , ease: punchgs.Power2.easeOut
                , clearProps: "transform"
            });
            break;
        case "hide":
            punchgs.TweenLite.to(inside, 0.1, {
                autoAlpha: 0
                , ease: punchgs.Power3.easeOut
            });
            punchgs.TweenLite.to(ul, 0.1, {
                ease: punchgs.Power3.easeIn
                , onComplete: function () {
                    punchgs.TweenLite.set(ul, {
                        autoAlpha: 0
...
function initSearch() {
    jQuery('.searchbutton').click(function () {
        ...
        punchgs.TweenLite.to(counter, 0.5, {
            val: 0
            , ease: punchgs.Power4.easeOut
            , onUpdate: function () {
                forcescrolled = true;
        ...
        var bsft = jQuery('#big_search_fake_txt')
            , myst = new punchgs.SplitText(bsft, {
                type: "words,chars"
            })
            , mytl = new punchgs.TimelineLite();
        mytl.pause(0);
        mytl.add(punchgs.TweenLite.to(bsft, 0.4, {
            x: 30
            , ease: punchgs.Power2.easeOut
        }));
        jQuery.each(myst.chars, function (index, chars) {
            mytl.add(punchgs.TweenLite.to(chars, 0.2, {
                autoAlpha: 0
                , scale: 0.8
                , ease: punchgs.Power2.easeOut
            }), (Math.random() * 0.2));
        ...
        inp.on('keyup', function (e) {
            if (inp.val().length == 0) mytl.reverse();
            else mytl.play();
        });
        ...
        punchgs.TweenLite.fromTo(sw, 0.4, {
            x: 0
            , y: 0
            , scale: 0.7
            , autoAlpha: 0
        ...
        punchgs.TweenLite.fromTo(sb, 0.4, {
            x: 0
            , y: 0
            , scale: 0.9
            , autoAlpha: 0
...
function initStickyMenu(recall) {
    ...
    if (jQuery('#header #subheader').length > 0) offs = offs + jQuery('#header #subheader').outerHeight();
    sh.tppoint('sticky', {
        offset: (-60 - offs)
        ...
        , handler: function (direction) {
            if (direction == "down") {
                ...
                punchgs.TweenLite.fromTo(sh, 0.5, {
                    y: -60
                }, {
                    y: 0
                    , delay: 0.3
            ...
            if (direction == "up") punchgs.TweenLite.to(sh, 0.0001, {
                y: 0
                , overwrite: "all"
                , display: "block"
            });
    ...
    if (!recall) {
        jQuery(window).resize(function () {
            if (jQuery('#header.stickyheader').hasClass("unsticked")) initStickyMenu(true);
        });
    }
}
...
function initStickyHeaderBg(recall) {
    var hb = jQuery('#header_background');
    hb.tppoint('sticky');
    if (!recall) jQuery(window).resize(function () {
        if (hb.hasClass("stuck")) hb.tppoint("unsticky").addClass("unsticked");
...
function initStickySideBar(recall) {
    ...
    if (!recall && jQuery('#sb-inner-wrap').length == 0) jQuery('#sidebar-container').wrapInner('<div id="sb-inner-wrap"></div>');
    ...
    if (mainwinw > 767 && dif >= (sb.outerHeight())) {
        if (sb.closest('.sticky-wrapper').length == 0) sb.tppoint('sticky', {
            offset: function () {
            ...
            , handler: function () {
                ...
                var offs = offb + jQuery('#header').height();
                offs = offs + jQuery('#header #subheader').outerHeight();
                if (jQuery('#sb-inner-wrap').hasClass("stuck")) jQuery('#sb-inner-wrap').css({
                    top: offs - 10
                })
                else {
                    jQuery('#sb-inner-wrap').css({
                        top: "auto"
                    })
                }
            }
...
function recalculateStickySideBar() {
    if (mainwinh != jQuery(window).data('miamilastknownwindowheight') || jQuery('#bodywrapper').height() != jQuery('#bodywrapper').data('miamilastknownbodyheight')) {
        ...
        if (mainwinw < 768 || dif < sb.outerHeight()) {
            if (sb.closest('.sticky-wrapper').length > 0) sb.tppoint("unsticky").addClass("unsticked");
            jQuery('#sb-inner-wrap').css({
                top: "auto"
            })
        }
...
function initMenuWidthAdjuster() {
    ...
    jQuery(window).on("resize.menuwidthadjust", function () {
        ...
        ti = setInterval(function () {
            if (checkMenuWidth() > 0) clearInterval(ti);
        }, 250)
    });
    ...
    var inte = setInterval(function () {
        ...
        if (cmw > 0 && jQuery('#navigation').data('canbestopped') == 1) clearInterval(inte);
    }, 100);
    setTimeout(function () {
        if (!is_mobile()) jQuery('#navigation').css({
            visibility: "visible"
            , height: "auto"
        });
        if (is_mobile()) jQuery('#navigation').css({
        ...
        jQuery('#header_widgets_wrapper').css({
            visibility: "visible"
            , height: "auto"
        });
        jQuery('#header_search').css({
            visibility: "visible"
            , height: "auto"
        });
    }, 200)
    ...
    jQuery('#menu-miami-menu>li .menu-item-has-children').hover(function () {
        var mi = jQuery(this)
            ...
            , ull = ul.offset().left
            , rs = (mainwinw - ull - ulw);
        if (rs < 0) ul.addClass("totheleft")
        else ul.removeClass("totheleft")
    });
...
function checkMenuWidth() {
    ...
    navw = nav.outerWidth(), hw = jQuery('#header .row').width(), headerww = jQuery('#header_widgets_wrapper'), hww = headerww.length > 0 ? headerww.css("display") == "none" ? 0 : headerww.outerWidth() : 0, headersw = jQuery('#header_search'), hsw = headersw.length > 0 ? headersw.css("display") == "none" ? 0 : headersw.outerWidth(true) : 0, headerpl = jQuery('#header_plus'), hpw = headerpl.length > 0 ? headerpl.css("display") == "none" ? 0 : headerpl.outerWidth(true) : 0, logow = jQuery('#logo_wrapper img').length > 0 ? jQuery('#logo_wrapper img').outerWidth(true) : 0, place = hw - (hww + hsw + hpw + logow);
    if (headerww.data('lkw') + navw <= (place - 20) && headerww.css("display") == "none" && !nav.hasClass("showmobile")) headerww.css({
        display: "block"
    });
    if (headersw.data('lkw') + navw <= (place - 50) && headersw.css("display") == "none" && !nav.hasClass("showmobile")) headersw.css({
        display: "block"
    });
    if (nav.data('lkw') <= (place - 20) && nav.hasClass("showmobile")) {
        nav.removeClass("showmobile")
        jQuery('#header_plus').css({
            visibility: "visible"
        });
    }
...
function designResponsiveMenu() {
    ...
    jQuery('#navigation .navigation a').each(function (i) {
        ...
        if (a.hasClass('menu-link') && !a.hasClass('wpmenucart-contents')) {
            ...
            switch (par) {
            case 0:
                if (lastpar == 0) fullappend = fullappend + "</div>";
                if (lastpar == 1) fullappend = fullappend + "</div></div>";
                if (lastpar == 2) fullappend = fullappend + "</div></div></div>";
                if (lastpar == 3) fullappend = fullappend + "</div></div></div></div>";
                break;
            case 1:
                if (lastpar == 1) fullappend = fullappend + "</div>";
                if (lastpar == 2) fullappend = fullappend + "</div></div>";
                if (lastpar == 3) fullappend = fullappend + "</div></div></div>";
                break;
            case 2:
                if (lastpar == 2) fullappend = fullappend + "</div>";
                if (lastpar == 3) fullappend = fullappend + "</div></div>";
                break;
            case 3:
                if (lastpar == 3) fullappend = fullappend + "</div>";
                break;
            default:
                break;
            }
    ...
    responsiveMenuWidth();
    jQuery('#responsivemenu').css({
        width: jQuery('#header_inner_wrapper').outerWidth()
    });
    jQuery('#mobile-navigation').click(function () {
        ...
        if (rep.css("display") == "none") {
            ...
            repw.css({
                top: jQuery('#header_inner_wrapper').outerHeight() + ot
                , zIndex: 500
            });
            rep.slideDown(200);
